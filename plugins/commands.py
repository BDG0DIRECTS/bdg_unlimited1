...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/official_kadda')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/movieupdate9"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('📰 Movie updates 🦾',url=f'https://t.me/Movie_updates9'),
            InlineKeyboardButton('♥️ Bot updates ♥️',url=f'https://t.me/official_kadda')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('❤️JOIN BACKUP❤️', url='https://t.me/bdgdirects')] [InlineKeyboardButton('📰Movies update', url='https://t.me/movieupdate9'),[InlineKeyboardButton('🌐online movies🌐', url='https://t.me/All_Movies_Series_Links')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
